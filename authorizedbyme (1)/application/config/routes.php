...
$route['profile/filechat'] = "user/dashboard/filechat";
$route['profile/textchat'] = "user/dashboard/textchat";
$route['profile/product'] = "user/dashboard/products";
$route['profile/add-product'] = "user/dashboard/add_product";
$route['profile/update-product/(:any)'] = "user/dashboard/update_product/$1";
...
// $route['admin/invoice-download/(:any)'] = "admin/Invoice/download/$1";
