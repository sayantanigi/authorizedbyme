...
<section class="breadcrumbpnl" style="background-image:url('<?= $banner_img ?>');">
    <div class="container">
        <div class="">
            <h3 class="fw-semibold"><?= $user ?> Details</h3>
            <div>
                <ol class="breadcrumb mb-2">
                    <li class="breadcrumb-item"><a href="<?= base_url() ?>">Home</a></li>
                    <li class="breadcrumb-item"><?= $user ?> Lists </a></li>
                                            ...
                                            foreach ($user_education as $edu) { ?>
                                                <div class="edu-history">
                                                    ...
                                                    <div class="edu-hisinfo">
                                                        <h3><?= ucfirst($edu->class_rank) ?> in <?= $edu->coursename ?> depertment
                                                        </h3>
                                    ...
                                    if (!empty($checkBookSlot)) {
                                        ...
                                        if (!empty($availability)) { ?>
                                            <div class="job-overview" style="height: 382px; overflow: auto; margin-top: 0px;">
                                                <p
                                                    style="width: 20%; display: inline-block; float: left; text-align: center; color: #000; font-size: 13px; font-weight: 600; font-family: Open Sans; margin: 0px !important;">
                                                    Start Date</p>
                                                <p
                                                    style="width: 20%; display: inline-block; float: left; text-align: center; color: #000; font-size: 13px; font-weight: 600; font-family: Open Sans; margin: 0px !important;">
                                                    From Time</p>
                                                ...
                                                foreach ($availability as $value) { ?>
                                                    <!-- <div> -->
                                                    <div class="job-overview"
                                                        style="width: 80%; background: #c7c7c7; margin: 0 0 5px 0 !important; padding: 0px; cursor: pointer;">
                                                        <p
                                                            style="width: 25%; display: inline-block; float: left; text-align: center; color: #000; font-size: 13px; font-weight: 600; font-family: Open Sans; margin: 0px !important;">
                                                            <?= date('d-m-Y', strtotime($value['start_date'])); ?></p>
                                                        <p
                                                            style="width: 25%; display: inline-block; float: left; text-align: center; color: #000; font-size: 13px; font-weight: 600; font-family: Open Sans; margin: 0px !important;">
                                                            <?= date('h:i A', strtotime($value['from_time'])) ?></p>
                                                        <p
                                                            style="width: 25%; display: inline-block; float: left; text-align: center; color: #000; font-size: 13px; font-weight: 600; font-family: Open Sans; margin: 0px !important;">
                                                            <?= date('h:i A', strtotime($value['to_time'])); ?></p>
                                                        <p
                                                            style="width: 25%; display: inline-block; float: left; text-align: center; color: #000; font-size: 13px; font-weight: 600; font-family: Open Sans; margin: 0px !important;">
                                                            <?= date('d-m-Y', strtotime($value['end_date'])) ?></p>
                                                    </div>
                                                    <div class="job-overview job_overview_main" id="job_overview_main_<?= $i ?>"
                                                        style="width: 15%; background: #c7c7c7; margin: 0 0 5px 10px !important; padding: 0px; cursor: pointer;">
                                                        <p
                                                            style="width: 100%; display: inline-block; float: left; text-align: center; color: #000; font-size: 13px; font-weight: 600; font-family: Open Sans; margin: 0px !important;">
                                                            View</p>
                                                    </div>
                                                    <!-- </div> -->
                                                    <div style="width: 100%;display: inline-block;background: #e1dfdf;margin: 0 0 5px 0;border-radius: 10px;padding: 10px;text-align: center;"
                                                        id="job_overview_sub_<?= $i ?>" class="job_overview_sub">
                                                        <?php $getBookSlot = $this->db->query("SELECT * FROM user_booking WHERE employer_id ='" . @$_SESSION['authorized']['userId'] . "' and available_id = '" . $value['avail_id'] . "'")->result_array();
                                                        // echo "<pre>";
                                                        // print_r($getBookSlot);
                                                        // die;
                                                            ...
                                                            <div style="width: 100%; display: inline-block;">
                                                                ...
                                                                <?php for ($i = 0; $i < count($bookingTime); $i++) {
                                                                    ...
                                                                    <div style="display: inline-block;width: 100%;">
                                                                        <p
                                                                            style="width: 50%;display: inline-block;float: left;margin: 0px;font-size: 14px;">
                                                                            <?= date('h:i A', strtotime($bookingTime[$i])) ?> to
                                                                            <?= date('h:i A', strtotime($bookingTime[$i]) + 60 * 60) ?></p>
                                                                        <p
                                                                            style="width: 50%;display: inline-block;float: left;margin: 0px;font-size: 14px;">
                                                                            <a href="<?= $meetingLink[$i] ?>">Meeting Link</a></p>
                                                                    </div>
                                                                <?php } ?>
                                                                <div>
                                                                    <p
                                                                        style="width: 100%;display: inline-block;float: left;margin: 0px;font-size: 14px;">
                                                                        Total Rate: <?= count($bookingTime) * @$user_detail->rateperhour ?></p>
                                                                </div>
                                                            </div>
                                                        <?php } else { ?>
                                        ...
                                        <?php } else { ?>
                                            <div class="job-overview" style="text-align: center;">No data added for availability
                                            </div>
                                        <?php }
                                    } else { ?>
                                        <div class="job-overview"
                                            style="height: auto; overflow: auto; margin-top: 0px; text-align: center;">No slot
                                            booked</div>
                                    <?php }
                                } ?>
                                <!-- Job Overview -->
...
<input type="hidden" name="user_id" id="user_id" value="<?php echo $_SESSION['authorized']['userId'] ?>">
                    ...
                    <div class='form-group date'>
                        <table class="table jobsites" id="purchaseTableclone1">
                            <tr class="color">
                                ...
                                <th><button type="button" class="btn btn-info addMoreBtn"
                                        onclick="add_row()">Add</button></th>
                            </tr>
                            <tbody id="clonetable_feedback1">
                                <tr>
                                    <td><input type="time" name="time" id="time1" class="form-control" required></td>
                                    <td><a href="javascript:void(0)" title="Delete" class="text-danger"
                                            onclick="return remove(this)">X</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<div class="modal fade edit-form" id="bookingmodal" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header border-bottom-0">
                <h5 class="modal-title" id="modal-title">Book Slot</h5>
                <button type="button" class="bookBtn-close btn-close" data-bs-dismiss="modal" aria-label="Close"
            ...
            <form id="myForm" class="avail_time">
                ...
                <div class="modal-footer border-top-0 d-flex justify-content-center">
                    <!-- <button type="submit" class="btn btn-success" id="submit-button1">Schedule</button>   onclick="aggrement1()" -->
                    <input type="button" class="btn btn-success" id="submit-button" value="Book Now"
                        onclick="bookNow()">
                </div>
            </form>
        </div>
...
<div class="modal fade edit-form" id="aggrementmodal" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content" style="width: 510px; height: 620px; overflow: auto;">
            ...
            <form id="myForm">
                <div class="modal-body">
                    ...
                    <div class="form-group date">
                        <input type="checkbox" id="aggrchck" name="vehicle2" value="1"
                            style="opacity: 1; z-index: 50; margin-top: 9px;">
                        <p style="display: inline-block; margin-left: 25px; margin-top: 0px; margin-bottom: 0px;"
                            class="user_aggrmnt">I have read and agree to PayperLLC aggrement and Policy.</p>
                        <p class="erroraggr"
                            style="margin: 0;width: 100%;text-align: center;color: red;font-size: 12px;">Please check
                            the checkbox.</p>
                    </div>
                </div>
                <div class="modal-footer border-top-0 d-flex justify-content-center">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        calendar.on('select', function (info) {
            ...
            <?php } else if (@$_SESSION['authorized']['userType'] == '1') { ?>
                    $.confirm({
                        title: '',
