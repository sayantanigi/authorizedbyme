...
function view_detail(transaction_id,status,invoice_pdf){
    ...
    // var btn = ''.anchor(base_url('page/postdetail/'.base64_encode($row->post_job_id)),'<span class="btn btn-sm bg-success-light mr-2"><i class="far fa-eye mr-1"></i></span>','target=_blank'); -->
