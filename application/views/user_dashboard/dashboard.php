	                    	...
	                    	<div  class="form-box text-start">
	                    		...
	                    		<div class="row">
					    			...
					    			<div class="col-lg-6 mb-3">
										...
										?>
										<img class="img-circle img-responsive" src="<?php echo base_url('uploads/no_image.png')?>" style="width: 68px;height: 68px;object-fit: cover;margin-top: -20px;" />
										<?php } else { ?>
										<img class="img-circle img-responsive" src="<?php echo base_url('uploads/users/'.$userinfo->profilePic); ?>" style="width: 68px;height: 68px;object-fit: cover;margin-top: -20px;" />
										<?php } } else { ?>
										<img class="img-circle img-responsive" src="<?php echo base_url('uploads/no_image.png')?>" style="width: 68px;height: 68px;object-fit: cover;margin-top: -20px;" />
										<?php } ?>
										<input type="hidden" name="old_image" value="<?=$userinfo->profilePic ?>">
										<input type="hidden" name="id" value="<?=$userinfo->userId  ?>">
										<div class="profile-ak" style="width: 88%; display: inline-block;">
